...
import '../lib/bootstrap-pagination/bootstrap-pagination.css'
import bstPagination from '../lib/bootstrap-pagination/bootstrap-pagination'
...
// 分页
function pageBreak(countPage = 1000, nowPage = 5 - 1, ) {

    var demo1 = bstPagination.BootstrapPagination($("#page-break"), {
...
newReportTable(globalFn.getReportData());
pageBreak()
    // refreshBtn();
export default {
    newReportTable,
